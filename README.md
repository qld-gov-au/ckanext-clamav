...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.clamav.some_setting = some_default_value
...
## Releasing a new version of ckanext-clamav

If ckanext-clamav should be available on PyPI you can follow these steps to publish a new version:
